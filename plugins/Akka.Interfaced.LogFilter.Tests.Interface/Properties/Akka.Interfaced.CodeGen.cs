...
namespace Akka.Interfaced.LogFilter.Tests
{
    ...
    public static class ITest_PayloadTable
    {
        ...
        public class CallWithActor_Invoke : IInterfacedPayload, IAsyncInvokable
        {
    ...
    {
        public TestRef(IActorRef actor)
            : base(actor)
        {
        }

        public TestRef(IActorRef actor, IRequestWaiter requestWaiter, TimeSpan? timeout)
