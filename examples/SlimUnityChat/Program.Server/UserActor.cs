...
namespace SlimUnityChat.Program.Server
{
    public class UserActor : InterfacedActor<UserActor>, IUser, IUserMessasing
    {
        ...
        protected static RequestMessageHandler<UserActor> OnBuildHandler(
            RequestMessageHandler<UserActor> handler, MethodInfo method)
        {
        ...
        async Task IUser.Whisper(string targetUserId, string message)
        {
            ...
            targetUserMessaging.Whisper(chatItem);
        }
