...
namespace PingpongInterface
{
    ...
    public class ClientRef : InterfacedActorRef, IClient, IClient_NoReply
    {
        ...
        private ClientRef() : base(null)
        {
        }

        public ClientRef(IActorRef actor) : base(actor)
        {
        }

        public ClientRef(IActorRef actor, IRequestWaiter requestWaiter, TimeSpan? timeout) : base(actor, requestWaiter, timeout)
        {
        }
